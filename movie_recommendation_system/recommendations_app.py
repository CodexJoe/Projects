...
img = Image.open('https://github.com/CodexJoe/Projects/main/movie_recommendation_system/Flix_img.png')
...
def main():
    ...
    if option =='Exploration and Preprocessing':
        ...
        df = pd.read_csv('https://github.com/CodexJoe/Projects/main/movie_recommendation_system/netflix_titles.csv')
